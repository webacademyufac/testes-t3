...
describe('<Collection>', () => {
  describe('Deve exibir uma coleção corretamente quando as informações passadas forem válidas', () => {// verifica se o título da coleção é exibido corretamente quando ele é passado como prop "title"
    it('Deve exibir o título da coleção quando ele for passado na prop "title"', () => {
      const title = faker.word.words(2);
      render(<Collection collection={collection({ title })} />);//a função render do @testing-library/react neste código é usada para renderizar o componente <Collection> com os dados da coleção fornecida e, em seguida, verifica se o título esperado está presente na tela usando a função getByText do screen.

      expect(screen.getByText(title)).toBeInTheDocument();
    });

    it('Deve exibir o subtítulo da coleção quando ele for passado na prop "subtitle"', () => {//o describe verifica se o subtítulo da coleção é exibido corretamente quando ele é passado como prop "subtitle"
    ...
    it('Deve exibir o nome do autor da coleção quando ele for passado na prop "author"', () => {// o  describe verifica se o nome do autor da coleção é exibido corretamente quando ele é passado como prop "author"
    ...
    it('Deve exibir o botão de editar coleção quando o componente for renderizado', () => {//aqui o describe verifica se o botão "Editar" da coleção é exibido corretamente quando o componente é renderizado
