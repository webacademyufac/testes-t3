...
import { faker } from '@faker-js/faker'; //o faker é uma biblioteca de geração de dados ficticios
...
describe('<Button />', () => {
  ...
  describe('Deve exibir o botão corretamente quando ele for renderizado', () => { //aqui o Describe estpa definindo um teste que é exibir o botao corretamente quando for renderizado
