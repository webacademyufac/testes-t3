import request, { SuperTest, Test } from 'supertest'; //aqui é utilizado o SuperTest que trabalha na parte de requisições HTTP
import express, { Express } from 'express'; //express auxilia na criação do aplicativo
import cors from 'cors'; //aqui é o importe de cors
...
jest.mock('../../app/repositories/ColecaoRepository', () => { //o jest.mock simula um repositório de coleções real
  const colecao = {
    id: 1,
    titulo: 'titulo',
    autor: 'autor',
...
describe('ColecaoController', () => {
  ...
  it('deve retornar 422 ao enviar um título com mais de 255 caracteres', async () => { //it define cada teste que está sendo verificado
