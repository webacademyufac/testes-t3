...
describe('CitacaoService', () => {
  ...
  describe('update', () => { //acredito que nessa parte seja o que define cada teste unitario
...
//o citacaoservice.ts é interessante pq permite que o dev consiga verificar se o CitacaoService está usando a lógica corretamente