...
//o APPerror é aparentemente uma classe personalizada para testar os fixtures e mocks
describe('ColecaoService', () => {
  ...
  afterEach(() => {
    jest.resetAllMocks(); //aqui é interessante por que o metodo aftereach reseta os mocks já feitos, ou seja, provavelmente os mocks reiniciam limpos
  });
