...
// Utilizando o mock de ColecaoRepository, esses testes irão testar as funções/métodos de um service de Coleção.
// A utilização de um mock aqui é essencial para facilitar e automatizar o teste de unidade, já que o foco é apenas o Colecaoservice
