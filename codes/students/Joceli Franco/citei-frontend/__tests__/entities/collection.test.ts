...
//O teste verifica se a entidade Collection está se comportando corretamente ao
//determinar se uma instância da coleção é válida, seguindo as regras estabelecidas na definição da classe.
