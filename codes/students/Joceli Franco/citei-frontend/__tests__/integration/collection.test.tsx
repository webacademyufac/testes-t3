...
//Este teste automatizado em Jest verifica o comportamento e as funções do componente Collection,
// usando mocks e simulações para fornecer serviços e dados necessários.
beforeAll(() => {
