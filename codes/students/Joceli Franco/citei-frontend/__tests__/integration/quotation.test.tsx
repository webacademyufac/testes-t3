...
//Os testes unitários validam a funcionalidade de gerenciamento de citações, 
//verificando a renderização correta da tela, a filtragem precisa das citações, 
//o bom funcionamento das operações de adição e a correta resposta da interface do usuário às ações.
