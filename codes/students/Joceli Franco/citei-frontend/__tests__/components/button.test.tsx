...
//Nessa parte do código é realizado testes no componente Button em diferentes cenários, 
//verificando se ele se comporta conforme o esperado. Esses testes tem o objetivo de identificar 
//possíveis problemas ou regressões no componente e garantir que ele atenda às expectativas definidas.
describe('<Button />', () => {
