...
//O teste avalia o comportamento do componente Quotation em diferentes cenários, 
//incluindo a exibição de informações e a funcionalidade de copiar ou compartilhar a citação.
// O objetivo é verificar se o componente está se comportando corretamente nessas situações.
describe('<Quotation>', () => {
