...
//O teste verifica se o componente Search está funcionando corretamente em diversos cenários, 
//realizando verificações apropriadas nas funções envolvidas em cada evento ocorrido.
describe('<Search />', () => {
