//As dependências necessárias são importadas para testar a funcionalidade de renderização
//do componente Collection
...
//Esses testes utilizam a biblioteca React Testing Library para verificar o comportamento
//do componente Collection. Os testes avaliam a exibição correta das informações, a interação do usuário 
//e garantem o funcionamento adequado do componente em diferentes cenários.
describe('<Collection>', () => {
