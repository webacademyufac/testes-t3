...
describe('ColecaoService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should call the repository with the specified title', async () => {
      await colecaoService.findAll('titulo');//vai chamar o repositorio
...
//verifica se a função findById acha um erro quando a ColecaoEntity com o ID especificado não é encontrada
  ...
  describe('create', () => {
    it('should create a new ColecaoEntity object', async () => {
      ...
      expect(result).toEqual(CreatedColecaoFixture);//vai criar um novo
  ...
  describe('delete', () => {
    it('should delete the ColecaoEntity object with the specified ID', async () => {
      await colecaoService.delete(1);//vai deletar o ID especificado
      expect(colecaoRepositoryMock.getColecaoOnly).toHaveBeenCalledWith(1);
