...
describe('CitacaoService', () => {
  ...
  // Aqui por exemplo ele faz testes relacionados ao FindById
  // No it ele ta esperando que retorne o objeto CitacaoEntity com o ID especificado.
  // no const ele ta chamando o método findById do citacaoService passando o id 1 e vai salvar no resultado
  // Agora no expect ele ta comparando com o toEqual para ver se batem
  // e por fim ele vai ver se o findbyid fdo citacaoreposi.. foi chamado corretamente 
  // essa prática vai ser parecido para as restantes mas com expectativas diferentes.
  describe('findById', () => {
